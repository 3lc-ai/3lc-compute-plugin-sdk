...
ALIAS_UI_JS = (
    ...
    "  window._tlcProjectRootPromises[pluginId] = API.authFetch(rootUrl)\n"
    "    .then(function(r) { return r.ok ? r.json() : {}; })\n"
    "    .then(function(c) { return String((c && c.url) || '').replace(/\\/$/, ''); })\n"
    "    .catch(function() { return ''; });\n"
    "  return window._tlcProjectRootPromises[pluginId];\n"
    "}\n"
...
PROJECT_LOCATION_JS = (
    ...
    "  window._tlcCloudRootPromise = API.authFetch(base + '/api/infra/capabilities')\n"
    "    .then(function(r) { return r.ok ? r.json() : {}; })\n"
    "    .then(function(c) {\n"
    ...
    "  return window._tlcCloudRootPromise;\n"
    "}\n"
